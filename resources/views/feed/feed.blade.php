        ...
        <section class="right">
            <div class="content-soulbeat">
                <div class="carrusel">
                    ...
                    @foreach ($company as $song)
                        @include('components.suggests.songs', [
                            'photo' => Storage::url($song->photo), 'id' => $song->id,
                            'price' => $song->cost, 'song' => Storage::url($song->song)
                        ])
                    @endforeach
                </div>
            </div>
                ...
                <div class="content-followers">
                    ...
                    <div class="forfollow">
                        @foreach ($users as $user)
                            @include('components.suggests.users', ['name' => $user->UserName, 'photo' => Storage::url($user->photo)])
                        @endforeach
                    </div>
                </div>
            @endif
