    ...
    <div class="wrapper-of-playlist">
        <section class="main-playlist">
            <nav class="up-playlist">
                <img class="foto-playlist" src="../front/images/playlist1.jpeg" alt="">
        ...
        <section class="show-songs">
            ...
            <div class="itemdecanciones">
                <div class="fotoplay">
                    <img src="../front/images/playlis3.jpg" alt="" class="imagenbeat">
                    <i class="bi bi-play-fill pla" data-audio-src="../front/audios/Shook Ones, Pt  II (Instrumental).mp3" ></i>
                </div>
                <div class="detalles">
                    
                    <nav class="infos">  
                        <span class="namebeat">Nombre</span>
                        <button class="interactions-songs">R</button>
                        <button class="interactions-songs">comprar</button>
                        <button class="interactions-songs">Descargar</button>
                        <button class="interactions-songs">Feature</button>
                    </nav>   
            ...
            <div class="itemdecanciones">
                <div class="fotoplay">
                    <img src="../front/images/foto-tupac-landing.jpeg" alt="" class="imagenbeat">
                    <i class="bi bi-play-fill pla" data-audio-src="../front/audios/Shook Ones, Pt  II (Instrumental).mp3"></i>
                </div>
                <div class="detalles">
                    <nav class="infos">  
            ...
            <div class="itemdecanciones">
                <div class="fotoplay">
                    <img src="../front/images/playlis2.jpeg" alt="" class="imagenbeat">
                    <i class="bi bi-play-fill pla" data-audio-src="../front/audios/Shook Ones, Pt  II (Instrumental).mp3"></i>
                </div>
                <div class="detalles">
            ...
            <div class="itemdecanciones">
                <div class="fotoplay">
                    <img src="../front/images/playlis4.jpeg" alt="" class="imagenbeat">
                    <i class="bi bi-play-fill pla" data-audio-src="../front/audios/Shook Ones, Pt  II (Instrumental).mp3"></i>
                </div>
                <div class="detalles">
